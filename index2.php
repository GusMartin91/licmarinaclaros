...
<nav class="navbar navbar-expand-lg">
  <div class="container">
    <a class="navbar-brand" href="#">
      <img src="assets/img/logo_nutricion.jpeg" alt="Logo" style="width: 100px;">
    </a>
...
<div class="container mt-5">
  ...
  <br>
    ...
    <section id="testimonios" class="section section-bg" style="background-image: url('assets/img/testimonios.jpg');">
      <div class="bg-overlay"></div>
      <div class="container">
    ...
    <section id="contacto" class="section section-bg" style="background-image: url('assets/img/contacto.jpg');">
      <div class="bg-overlay"></div>
      <div class="container">
  ...
  <div class="container">
    ...
    <div class="row mt-3">
      <div class="col">
        <p>© 2024 Marina Claros. Todos los derechos reservados.</p>
      </div>
    </div>
  </div>
</footer>
