...
$actualizacionCampos = [
    'fecha_proxima_consulta_HC', 'peso_HC', 'observaciones_HC'
];
switch ($datos['movimiento_HC']) {
    case 'A':
        $tipo_auditoria = 'Alta';
        $sqlInsert = "INSERT INTO historial_consultas (dni_paciente, observaciones, fecha_consulta, fecha_proxima_consulta, peso, movimiento, usuario) 
        VALUES ('{$datos['dni_HC']}', '{$datos['observaciones_HC']}', " . ($datos['fecha_consulta_HC'] ? "'{$datos['fecha_consulta_HC']}'" : 'NULL') . ", " . ($datos['fecha_proxima_consulta_HC'] ? "'{$datos['fecha_proxima_consulta_HC']}'" : 'NULL') . ", '{$datos['peso_HC']}', '{$datos['movimiento_HC']}', '$usuario')";
        break;
    case 'U':
        $tipo_auditoria = 'Actualizacion';
        $sqlUpdate = "UPDATE historial_consultas SET fecha_consulta = " . ($datos['fecha_consulta_HC'] ? "'{$datos['fecha_consulta_HC']}'" : 'NULL') . ", fecha_proxima_consulta = " . ($datos['fecha_proxima_consulta_HC'] ? "'{$datos['fecha_proxima_consulta_HC']}'" : 'NULL') . ", peso = '{$datos['peso_HC']}', observaciones = '{$datos['observaciones_HC']}', usuario = '$usuario', movimiento = 'M'
