            ...
            <div class="modal-body">
                <form action="./backend_HC.php" id="form_HC" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-xs-12 col-sm-6 mb-2">
                            <label for="fecha_proxima_consulta_HC" class="form-label">Fecha proxima consulta:</label>
                            <input type="date" name="fecha_proxima_consulta_HC" id="fecha_proxima_consulta_HC" class="form-control">
                        </div>
                        <hr>
                        <div class="col-xs-12 col-sm-6 mb-2">
