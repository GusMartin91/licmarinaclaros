            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a href="#" id="boton_cerrar_sesion_admin" class="nav-link">| <i class="fa-sharp fa-solid fa-lock"></i> Cerrar sesion</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" id="boton_admin" class="nav-link">| <i class="fa-solid fa-gear"></i> Panel Admin</a>
                        </li>
